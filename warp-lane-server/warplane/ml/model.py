...
class WaveNetRegressor(keras.Model):
    ...
    def build(self, input_shape):
        ...
        for ix, layer_max_dilation_factor in enumerate(self.layer_max_dilation_factors):
            ...
            self.channel_match_convs.append(layers.Conv1D(layer_filters, 1, padding='same'))
